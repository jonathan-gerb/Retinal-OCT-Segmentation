...
#     n_columns = 5
#     n_rows = 2 * int((len(transformations) + 1) / n_columns)
...
#         plt.title(transform.__str__())

#         plt.subplot(n_rows, n_columns, i + 2 + len(transformations) + 1)
#         plt.imshow(transformed_mask.permute(1, 2, 0).numpy())
#         plt.title(transform.__str__())
