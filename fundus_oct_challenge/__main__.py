...
def main():
    ...
    if cfg.TRAIN.DO_TRAIN:
        ...
        train_dataset = FundusOctDataset(cfg.DATA.BASEPATH, "train", transforms=transforms_train)
        val_dataset = FundusOctDataset(cfg.DATA.BASEPATH, "val", transforms=transforms_val)
        ...
        val_dataloader = DataLoader(val_dataset, batch_size=cfg.TRAIN.TRAIN_BATCH_SIZE, shuffle=False, num_workers=cfg.DATA.NUM_WORKERS)
